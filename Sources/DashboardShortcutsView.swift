        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                VStack(spacing: 8) {
                    ...
                    Divider().background(Color.white.opacity(0.04))
                    shortcutRow(keys: "⌃ X", title: "Stop Speech", desc: "Quick shortcut to stop active playback immediately")
                    Divider().background(Color.white.opacity(0.04))
                    shortcutRow(keys: "Esc", title: "Quick Dismiss", desc: "Instantly silence playback and dismiss notch HUD")
                    Divider().background(Color.white.opacity(0.04))
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                VStack(spacing: 8) {
                    ...
                    Divider().background(Color.white.opacity(0.04))
                    cliRow(cmd: "aspk stop", desc: "Silence and dismiss active speech playback")
                    Divider().background(Color.white.opacity(0.04))
